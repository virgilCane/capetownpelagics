...
<div class="body">
    ...
    <div class="site-header-wrapper">
        ...
        <header class="site-header">
            <div class="container">
                <div class="site-logo">
                    <a href="index.html" class="default-logo"><img src="images/logo.png" alt="Logo"></a>
    	...
    	<div class="page-banner parallax" style="background-image:url(http://placehold.it/1280x400&amp;text=IMAGE+PLACEHOLDER);">
        	<div class="container">
            	<div class="page-banner-text">
        			<h1 class="block-title">Gallery with caption 4 columns</h1>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <ul class="sort-destination isotope gallery-items" data-sort-id="gallery">
                        <li class="col-md-3 col-sm-6 col-xs-6 grid-item gallery-grid-item images format-image">
                            ...
                            <div class="grid-item-content">
                                <p>Maybe one day I'll be able to fly</p>
                            </div>
                        </li>
                        <li class="col-md-3 col-sm-6 col-xs-6 grid-item gallery-grid-item sliders format-gallery">
                            ...
                            <div class="grid-item-content">
                                <p>Young students presenting their country with flags</p>
                            </div>
                        </li>
                        <li class="col-md-3 col-sm-6 col-xs-6 grid-item gallery-grid-item links format-link">
                            ...
                            <div class="grid-item-content">
                                <p>This gallery item is linked to google.com website</p>
                            </div>
                        </li>
                        <li class="col-md-3 col-sm-6 col-xs-6 grid-item gallery-grid-item videos format-video">
                            ...
                            <div class="grid-item-content">
                                <p>This gallery item is linked to a Vimeo video</p>
                            </div>
                        </li>
                        <li class="col-md-3 col-sm-6 col-xs-6 grid-item gallery-grid-item images format-image">
                           	<a href="http://placehold.it/600x400&amp;text=IMAGE+PLACEHOLDER" class="media-box magnific-image"> <img src="http://placehold.it/600x400&amp;text=IMAGE+PLACEHOLDER" alt=""> </a>
                            <div class="grid-item-content">
                                <p>Child labour is the worst thing in the world</p>
                            </div>
                        </li>
                        <li class="col-md-3 col-sm-6 col-xs-6 grid-item gallery-grid-item sliders format-gallery">
                            <div class="media-box">
