...
<div class="body">
    ...
    <div class="carousel-wrapper">
                        <div class="row">
                            <ul class="owl-carousel carousel-fw" id="causes-slider" data-columns="3" data-autoplay="" data-pagination="no" data-arrows="yes" data-single-item="no" data-items-desktop="4" data-items-desktop-small="3" data-items-tablet="2" data-items-mobile="1">
                                <li class="item">
                                    <div class="grid-item cause-grid-item small-business format-standard">
                                        <div class="grid-item-inner">
                                            <a href="register.php" class="media-box">
                                                <img src="./images/CTP_Black-browAlb_AdB.JPG" alt="">
                                            </a>
                                            <div class="grid-item-content">
                                                <h3 class="post-title"><a href="register.php">Register a new <br>admin account</a></h3>
                                ...
                                <li class="item">
                                    <div class="grid-item cause-grid-item small-business format-standard">
                                        <div class="grid-item-inner">
                                            <a href="adgal.php" class="media-box">
                                                <img src="./images/CTP_FleshFootedShearwaterDG.jpg" alt="">
                                            </a>
                                            <div class="grid-item-content">
                                                <h3 class="post-title"><a href="adgal.php">Upload pictures <br> to the gallery</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                <li class="item">
                                    <div class="grid-item cause-grid-item small-business format-standard">
                                        <div class="grid-item-inner">
                                            ...
                                            <div class="grid-item-content">
                                                <h3 class="post-title"><a href="#">Upload a new <br>trip report</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </li>
