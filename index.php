                            	...
                            	<ul class="events-compact-list">
                                	<li class="event-list-item">	
                                        ...
                                        <div class="event-list-cont">
                                        	...
                                        	<h4 class="post-title"><a href="#">Humpback Whales</a></h4>
                    						<p>Humpback Whales breaching right next to our boat on Sunday 5 July's pelagic trip! Our guide Dalton Gibbs took 
                                                several spectacular close up photos. The bird species seen during the day are listed in his trip report. </p>
                                        </div>
                                    </li>
                                	<li class="event-list-item">
                                    	<span class="event-date">
                                        ...
                                        <div class="event-list-cont">
                                        	...
                                        	<h4 class="post-title"><a href="#">Wandering Albatross</a></h4>
                    						<p>A juvenile wandering albatross was sighted, along with 4 other albatross species on the 17 May trip.
                                                Other highlights include a close view of a spectacled petrel as well as several migrant Black-bellied Storm Petrels.
                                            </p>
                                        </div>
                                    </li>
                                	<li class="event-list-item">
                                        ...
                                        <div class="event-list-cont">
                                        	...
                                        	<h4 class="post-title"><a href="#">A fine day for birding</a></h4>
                    						<p>This trip presented an excellent cross-section of late summer and  early winter birds. Highlights include
                                                Black-bellied Storm Petrels, an Antarctic Prion, 4 Albatross species, a Great-winged Petrel as well as a Loggerhead turtle.
                                            </p>
                                        </div>
                                    </li>
                                </ul>
